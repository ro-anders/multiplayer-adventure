...
public:
	...
	*/
	WinUdpTransport(const Address& myExternalAddr, const Address& theirAddr);
	...
	*/
	WinUdpTransport(const Address& myExternalAddr, int transportNum, const Address& otherAddr1, const Address& otherAddr2);
