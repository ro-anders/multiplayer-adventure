...
static const COLOR colorTable [] =
{
    ...
    { 0xcf,0x4d,0x0c }, // copper
    { 0x00,0xa8,0x6b }, // jade
    { 0xa8,0xfc,0x41 }  // flash (0xcb)
};
enum { COLOR_BLACK=0, COLOR_LTGRAY, COLOR_WHITE, COLOR_YELLOW, COLOR_ORANGE, COLOR_RED, COLOR_PURPLE, COLOR_BLUE, COLOR_LTCYAN, COLOR_CYAN, COLOR_DKGREEN, COLOR_LIMEGREEN, COLOR_OLIVEGREEN, COLOR_TAN, COLOR_COPPER, COLOR_JADE, COLOR_FLASH };
