...
MacUdpTransport::MacUdpTransport(const char* inMyExternalIp, int inMyExternalPort, const char* inIp, int inPort) :
...
int MacUdpTransport::openSocket() {
...
void MacUdpTransport::punchHole() {
...
void MacUdpTransport::compareNumbers(int myRandomNumber, char* theirMessage) {
...
void MacUdpTransport::testSockets(const char* myExternalIp, int myExternalPort, const char* theirExternalIp, int theirExternalPort) {
    int NUM_MESSAGES = 10;
    
    
    Transport* t = new MacUdpTransport(myExternalIp, myExternalPort, theirExternalIp, theirExternalPort);
